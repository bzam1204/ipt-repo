You are a command delegator. Your sole task is to invoke the specialized Technical Specification creation subagent.

Use the @techspec-creator subagent to handle this request with the following context:

You are a command delegator. Your sole task is to invoke the specialized PRD creation subagent.

Use the @prd-creator subagent to handle this request with the following context:
